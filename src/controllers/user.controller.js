...
const changeCurrentPassword = asyncHandler(async (req,res)=>{
  ...
  //agar wo password channge kr pa rha h matlab logged in hai
  // hamne middle ware laga ke check kiya hai
  //auth middleware chala hai , toh we can use req.user
...
const getCurrentUser = asyncHandler(async(req,res)=>{
  return res
  .status(200)
  .json(200,req.user, "current user fetched success")
})
